...
public class ExcelXlsx {
	...
	public static void Connection(String excelName, String sheetName) throws IOException {
		try {
	...
	public static void getData(int rowNo, int colNo) {
		try {
			System.out.println(sheet.getRow(rowNo).getCell(colNo).getStringCellValue());
	...
	public static void setData(int rowNo, int colNo, String text) throws IOException {
