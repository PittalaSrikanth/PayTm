...
public static WebDriver selectBrowser(String browser){
	...
	{
		System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir")+"\\src\\companyName\\BrowserDrivers\\chromedriver.exe");
	...
	{
		System.setProperty("webdriver.ie.driver", System.getProperty("user.dir")+"\\src\\companyName\\BrowserDrivers\\ie.exe");
	...
	public static void implicitWait(int sec){
		Reporter.log("implicitWait for"+getPageTittle()+" page loading:" +sec);
		try {
		...
		public static void explecitWati(WebElement element,int sec){
			try {
				Reporter.log("explecitWati for"+getPageTittle()+" page loading:" +sec);
	...
	public static void mandatoryWait(int sec) throws InterruptedException{
		try {
			Reporter.log("mandatoryWait for"+getPageTittle()+" page loading:" +sec);
		...
		public static void selectDropDown(WebElement e,String value){
		...
		public static void actionDropDown(WebElement e,String text){
		...
		public static void actionClick(WebElement e){
		 ...
		 public static void actionSendKeys(WebElement e,String data){
			 Actions a = new Actions(driver);
			 a.click(e).build().perform();
