...
public class Action extends TestBase {
	...
	/*public static void LoginPage() throws Exception{
		ExcelXlsx.Connection("login.xlsx", "LoginPage_LoginTab");
		link(ExcelXlsx.getData("e2"), ExcelXlsx.getData("F2"));
		link(ExcelXlsx.getData("e3"), ExcelXlsx.getData("F3"));
		textbox(ExcelXlsx.getData("e4"), ExcelXlsx.getData("F4"),ExcelXlsx.getData("g4"));
		textbox(ExcelXlsx.getData("e5"), ExcelXlsx.getData("F5"),ExcelXlsx.getData("g5"));
		button(ExcelXlsx.getData("e6"), ExcelXlsx.getData("F6"));
...
*/
	...
	public static   WebElement getLocator(String keyWordType,
		...
		if (keyWordType.equalsIgnoreCase("id")) {
			...
			throw new Exception("Unknown element loacatorType : " + keyWordtValue);
...
public static void button(String keywordType, String keywordvalue) throws Exception  {
